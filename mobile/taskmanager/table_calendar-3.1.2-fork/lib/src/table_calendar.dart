...
class TableCalendar<T> extends StatefulWidget {
  ...
  /// Optional handler for vertical swipe
  void Function(SwipeDirection swipeDirection)? onVerticalSwipe;
      ...
      children: [
        ...
        Flexible(
          ...
          child: TableCalendarBase(
            ...
            onVerticalSwipe: widget.onVerticalSwipe ?? _swipeCalendarFormat,
